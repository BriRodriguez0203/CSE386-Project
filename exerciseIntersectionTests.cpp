...
int main(int argc, char* argv[]) {
	...
	ISphere s(dvec3(2, 1, 2), 1.0);

	IPlane p(dvec3(1, 2, 3), dvec3(-1/glm::sqrt(3), -1 / glm::sqrt(3), -1 / glm::sqrt(3)));
	Ray ray(dvec3(10, 0, 2), dvec3(-1 / glm::sqrt(3), -1 / glm::sqrt(3), -1 / glm::sqrt(3)));
	HitRecord hit;

	p.findClosestIntersection(ray, hit);
	cout << hit.t << endl;
	cout << hit.normal << endl;
	cout << hit.interceptPt << endl;
