...
ICylinderX* cylinderX = new ICylinderX(dvec3(-4.0, 3.0, 0.0), 5.0, 5.0);
ICylinderY* cylinderY = new ICylinderY(dvec3(0.0, 0.0, 0.0), 2.0, 4.0);
IClosedCylinderY* closedCylinderX = new IClosedCylinderY(dvec3(-10.0, 0.0, 4.0), 3.0, 3.0);
ISphere* sphere = new ISphere(dvec3(5.0, 1.0, -11.0), 2.0);
IConeY* cone = new IConeY(dvec3(-5, 5, -5), 2.0, 5.0);

void buildScene() {
	scene.addOpaqueObject(new VisibleIShape(plane, tin));
	scene.addTransparentObject(new TransparentIShape(clearPlane, red, 0.25));

	scene.addOpaqueObject(new VisibleIShape(cylinderY, red));
	scene.addOpaqueObject(new VisibleIShape(closedCylinderX, gold));
	//scene.addOpaqueObject(new VisibleIShape(cylinderX, blue));
	scene.addOpaqueObject(new VisibleIShape(sphere, blue));
