...
PositionalLight posLight(dvec3(20, 20, 20), white);
...
ICylinderX* cylinderX = new ICylinderX(dvec3(-4.0, 5.0, 0.0), 5.0, 3.0);
IClosedCylinderY* closedCylinderX = new IClosedCylinderY(dvec3(4.0, 5.0, 0.0), 5.0, 3.0);
...
//IDisk* disk = new IDisk(dvec3(4.0, 7.0, 0.0), dvec3(0.0, 1.0, 0.0), 5.0);
...
void buildScene() {
	...
	//scene.addOpaqueObject(new VisibleIShape(cylinderX, gold));
	//scene.addOpaqueObject(new VisibleIShape(disk, silver));
